...
func (fake *Message) AckCallCount() int {
	fake.ackMutex.RLock()
	defer fake.ackMutex.RUnlock()
	return len(fake.ackArgsForCall)
}

func (fake *Message) AckCalls(stub func()) {
	fake.ackMutex.Lock()
	defer fake.ackMutex.Unlock()
	fake.AckStub = stub
}

func (fake *Message) Duplicate() bool {
...
func (fake *Message) DuplicateReturnsOnCall(i int, result1 bool) {
	fake.duplicateMutex.Lock()
	defer fake.duplicateMutex.Unlock()
	fake.DuplicateStub = nil
...
func (fake *Message) MessageID() uint16 {
...
func (fake *Message) MessageIDReturnsOnCall(i int, result1 uint16) {
	fake.messageIDMutex.Lock()
	defer fake.messageIDMutex.Unlock()
	fake.MessageIDStub = nil
...
func (fake *Message) Payload() []byte {
...
func (fake *Message) PayloadReturnsOnCall(i int, result1 []byte) {
	fake.payloadMutex.Lock()
	defer fake.payloadMutex.Unlock()
	fake.PayloadStub = nil
...
func (fake *Message) QosCallCount() int {
	fake.qosMutex.RLock()
	defer fake.qosMutex.RUnlock()
	return len(fake.qosArgsForCall)
}

func (fake *Message) QosCalls(stub func() byte) {
	fake.qosMutex.Lock()
	defer fake.qosMutex.Unlock()
	fake.QosStub = stub
}

func (fake *Message) QosReturns(result1 byte) {
	fake.qosMutex.Lock()
	defer fake.qosMutex.Unlock()
	fake.QosStub = nil
...
func (fake *Message) QosReturnsOnCall(i int, result1 byte) {
	fake.qosMutex.Lock()
	defer fake.qosMutex.Unlock()
	fake.QosStub = nil
...
func (fake *Message) Retained() bool {
...
func (fake *Message) RetainedReturnsOnCall(i int, result1 bool) {
	fake.retainedMutex.Lock()
	defer fake.retainedMutex.Unlock()
	fake.RetainedStub = nil
...
func (fake *Message) Topic() string {
...
func (fake *Message) TopicCallCount() int {
	fake.topicMutex.RLock()
	defer fake.topicMutex.RUnlock()
	return len(fake.topicArgsForCall)
}

func (fake *Message) TopicCalls(stub func() string) {
	fake.topicMutex.Lock()
	defer fake.topicMutex.Unlock()
	fake.TopicStub = stub
}

func (fake *Message) TopicReturns(result1 string) {
	fake.topicMutex.Lock()
	defer fake.topicMutex.Unlock()
	fake.TopicStub = nil
...
func (fake *Message) TopicReturnsOnCall(i int, result1 string) {
	fake.topicMutex.Lock()
	defer fake.topicMutex.Unlock()
	fake.TopicStub = nil
...
func (fake *Message) Invocations() map[string][][]interface{} {
...
func (fake *Message) recordInvocation(key string, args []interface{}) {
...
var _ mqtt.Message = new(Message)
